...
Page(Object.assign({}, Toast, {
     ...
     */
      ...
      * 是否允许1岁以下婴儿 - 选择
      */
     handleSelectedAllowBaby: function () {

          var that = this;
          if (true) {

               that.setData({
                    'userSelectedLineDetail.isAllowBabySelected': 1
               })
          } else {
     ...
     calculateAmount: function () {
          ...
          console.log("adultAmount = " + adultAmount + ", childAmount = " + childAmount + ", oldAmount = " + oldAmount);
