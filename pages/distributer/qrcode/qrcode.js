...
Page(Object.assign({}, Toast, {
  ...
  onLoad: function (options) {
    ...
    var that = this;
    if (!util.isEmptyStr(options.shopName) && !util.isEmptyStr(options.qrcodeUrl) && !util.isEmptyStr(options.logoUrl)) {

      that.setData({

        qrCodeUrl: options.qrcodeUrl,
        avatarUrl: options.logoUrl,
        userName: options.shopName
      });
      ...
      var message = "options.shopName, options.qrcodeUrl, options.logoUrl 都不能为空"
